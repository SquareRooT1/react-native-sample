...
class AndroidCircle extends Component {
  propTypes: {
  ...
  constructor(props) {
    ...
    if (percent >= 50) {
      ...
      rightTransformerDegree = 180 +'deg';
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (percent >= 50) {
      ...
      rightTransformerDegree =  180 - (- percent*3.6) + 'deg';
    }
    this.setState({
      percent: this.props.percent,
      borderWidth: this.props.borderWidth < 2 || !this.props.borderWidth ? 2 : this.props.borderWidth,
...
AndroidCircle.defaultProps = {
  bgcolor: '#e3e3e3',
  innerColor: '#fff'
};

module.exports = AndroidCircle;
